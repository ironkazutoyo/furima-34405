class OrderFormObject
  ...
  attr_accessor :postal_code, :prefecture_id, :municipality, :address, :building, :tel_num, :order_history_id, :user_id,
                :item_id, :token
  ...
  def save
    ...
    Order.create(postal_code: postal_code, prefecture_id: prefecture_id, municipality: municipality, address: address,
                 building: building, tel_num: tel_num, order_history_id: order_history.id)
  end
end
